...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    if (valueAfterLabelFont != null) {
      valueAfterLabel.setFont(valueAfterLabelFont);
    }
    valueAfterLabel.setForeground(new Color(-16777216));
    valueAfterLabel.setText("Restguthaben:");
    panel1.add(valueAfterLabel,
    ...
    panel1.add(underMinWarning,
        new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
