...
public enum PermissionKey {
  ...
  ARTICLE_CATALOGPRICEFACTOR_READ(Article.class),
  ARTICLE_CATALOGPRICEFACTOR_WRITE(Article.class),
  ARTICLE_LABELCOUNT_READ(Article.class),
  ARTICLE_LABELCOUNT_WRITE(Article.class),
  ARTICLE_LABELPERUNIT_READ(Article.class),
  ARTICLE_LABELPERUNIT_WRITE(Article.class),
