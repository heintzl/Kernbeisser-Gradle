...
public enum UserPersistFeedback implements Named {
    ...
    CANNOT_LEAF_USER_GROUP("Die Nutzergruppe kann leider nicht verlassen werden,\nda kein weiter Nutzer in ihr ist"),
    NO_USER_GROUP_SELECTED("Es ist keine Nutzergruppe ausgew\u00e4hlt bitte w\u00e4hlen sie eine aus"),
