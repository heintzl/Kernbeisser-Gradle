...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel5.add(spacer1, new GridConstraints(9, 3, 1, 1, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0,
        false));
    importItems = new JCheckBox();
    importItems.setEnabled(false);
    importItems.setText("Artikel");
    panel5.add(importItems,
    ...
    panel5.add(dataPath, new GridConstraints(1, 0, 1, 4, GridConstraints.ANCHOR_WEST,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
        GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(100, -1), null, 0, false));
    search = new JButton();
    search.setText("Suchen");
    panel5.add(search, new GridConstraints(1, 4, 1, 1, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, new Dimension(100, -1), 0, false));
    importUser = new JCheckBox();
    importUser.setEnabled(false);
    importUser.setText("Nutzer");
    panel5.add(importUser,
    ...
    panel5.add(itemProgress, new GridConstraints(3, 0, 1, 5, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
    ...
    panel5.add(userProgress, new GridConstraints(5, 0, 1, 5, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(200, -1), null, 0, false));
    final Spacer spacer2 = new Spacer();
    panel5.add(spacer2, new GridConstraints(9, 0, 1, 3, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null,
        0, false));
    currentActionItems = new JLabel();
    currentActionItems.setText("Artikel:");
    currentActionItems.setVisible(false);
    panel5.add(currentActionItems,
    ...
    panel5.add(importStandardAdmin,
        new GridConstraints(6, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    panel5.add(adminPassword, new GridConstraints(7, 2, 1, 1, GridConstraints.ANCHOR_WEST,
        GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW,
