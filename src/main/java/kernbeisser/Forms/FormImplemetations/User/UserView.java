...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    main.setMinimumSize(new Dimension(254, 400));
    main.setPreferredSize(new Dimension(404, 900));
    ...
    if (lblVornameFont != null) {
      lblVorname.setFont(lblVornameFont);
    }
    ...
    if (lblNachnameFont != null) {
      lblNachname.setFont(lblNachnameFont);
    }
    ...
    if (lblStrasseFont != null) {
      lblStrasse.setFont(lblStrasseFont);
    }
    ...
    if (grpAddressFont != null) {
      grpAddress.setFont(grpAddressFont);
    }
    ...
    if (lblTelefon1Font != null) {
      lblTelefon1.setFont(lblTelefon1Font);
    }
    ...
    if (lblTelefon2Font != null) {
      lblTelefon2.setFont(lblTelefon2Font);
    }
    ...
    if (grpLoginFont != null) {
      grpLogin.setFont(grpLoginFont);
    }
    ...
    if (lblRolleFont != null) {
      lblRolle.setFont(lblRolleFont);
    }
    ...
    if (lblHasKeyFont != null) {
      lblHasKey.setFont(lblHasKeyFont);
    }
    ...
    if (lblIsEmployeeFont != null) {
      lblIsEmployee.setFont(lblIsEmployeeFont);
    }
    ...
    if (grpGenossenschaftFont != null) {
      grpGenossenschaft.setFont(grpGenossenschaftFont);
    }
    ...
    if (lblDiensteFont != null) {
      lblDienste.setFont(lblDiensteFont);
    }
    ...
    if (separator3Font != null) {
      separator3.setFont(separator3Font);
    }
    ...
    if (separator4Font != null) {
      separator4.setFont(separator4Font);
    }
    ...
    if (separator5Font != null) {
      separator5.setFont(separator5Font);
    }
    ...
    if (lblAnteileFont != null) {
      lblAnteile.setFont(lblAnteileFont);
    }
    ...
    label5.setText("letzte Änderung:");
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 21;
    gbc.weightx = 1.0;
    ...
    if (updateInfoFont != null) {
      updateInfo.setFont(updateInfoFont);
    }
