...
public class Articles {
    ...
    public static Article parse(String[] rawArticleValues, HashSet<Long> barcodes, HashSet<String> names,
                                HashMap<String,Supplier> suppliers, HashMap<String,PriceList> priceLists)
