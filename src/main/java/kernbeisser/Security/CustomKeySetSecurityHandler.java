...
public class CustomKeySetSecurityHandler implements MethodHandler {
    ...
    public Object invoke(Object proxy, Method proxyMethod,Method original, Object[] args) throws IllegalAccessException, IllegalArgumentException,
                                                                                                 ...
                                                                                                 AccessDeniedException
    {
        ...
        else throw new AccessDeniedException("User[" + LogInModel.getLoggedIn().getIdWithoutPermission() + "] cannot access " + original + " because the user has not the required Keys:" + Arrays
                .toString(key.value()));
        return out;
    }
