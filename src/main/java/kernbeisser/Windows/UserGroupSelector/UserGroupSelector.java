...
public class UserGroupSelector extends Window {
    ...
    public UserGroupSelector(Window current, Consumer<UserGroup> f) {
        ...
        userTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                selectUser(em.createQuery(
                        "select u from User u where username = '" + userTable.getValueAt(userTable.getSelectedRow(),
                                                                                         0) + "'", User.class)
                             .getSingleResult());
            }
        });
    ...
    private void initComponents() {
        ...
        groupMembers.setBorder(
                javax.swing.BorderFactory.createTitledBorder(null, "Mitglieder", javax.swing.border.TitledBorder.CENTER,
    ...
    private void searchBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBarActionPerformed
        userTable.setQuery(
                "select u from User u where firstName like '%" + searchBar.getText() + "%' or surname like '%" + searchBar
                        .getText() + "%' ORDER BY firstName asc");
        userTable.refresh();
