...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    main.add(tabbedPane,
        new GridConstraints(0, 0, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
    ...
    panel1.add(panel2,
        new GridConstraints(0, 0, 13, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
    ...
    if (firstNameFont != null) {
      firstName.setFont(firstNameFont);
    }
    ...
    if (phoneNumber2Font != null) {
      phoneNumber2.setFont(phoneNumber2Font);
    }
    phoneNumber2.setForeground(new Color(-4473925));
    phoneNumber2.setText("tele2");
    panel2.add(phoneNumber2,
    ...
    if (townCodeFont != null) {
      townCode.setFont(townCodeFont);
    }
    ...
    if (solidarySurchargeFont != null) {
      solidarySurcharge.setFont(solidarySurchargeFont);
    }
    solidarySurcharge.setForeground(new Color(-4473925));
    solidarySurcharge.setText("solidarySurcharge");
    panel2.add(solidarySurcharge,
    ...
    if (createDateFont != null) {
      createDate.setFont(createDateFont);
    }
    createDate.setForeground(new Color(-4473925));
    createDate.setText("createDate");
    panel2.add(createDate,
    ...
    if (updateDateFont != null) {
      updateDate.setFont(updateDateFont);
    }
    updateDate.setForeground(new Color(-4473925));
    updateDate.setText("updateDate");
    panel2.add(updateDate,
        new GridConstraints(13, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0,
            false));
    final Spacer spacer1 = new Spacer();
    panel2.add(spacer1, new GridConstraints(15, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
    ...
    panel2.add(close, new GridConstraints(16, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    editUser = new JButton();
    editUser.setText("Bearbeiten...");
    panel2.add(editUser, new GridConstraints(14, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
        GridConstraints.FILL_HORIZONTAL,
        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
        GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    panel1.add(scrollPane2,
        new GridConstraints(1, 1, 4, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null,
            null, null, 0, false));
    ...
    panel1.add(scrollPane3,
        new GridConstraints(10, 1, 3, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW,
            GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null,
            null, null, 0, false));
