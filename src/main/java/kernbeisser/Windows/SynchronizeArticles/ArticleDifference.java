...
public class ArticleDifference <T>{
  public ArticleDifference(Difference<Article,T> articleDifference,Article current,Article newVersion){
  ...
  @Getter
  private final Difference<Article,T> articleDifference;
  @Getter
  private final Article current;
