...
public class EditUserSettingController implements Controller<EditUserSettingView,EditUserSettingModel> {
    ...
    public void fontChanged() {
        ...
        view.setExampleTextFont(new Font(before.getName(),before.getStyle(),Math.round(before.getSize()*view.getFontSize())));
    }
