...
public class EditSupplierView implements View<EditSupplierController> {
    ...
    public void initialize(EditSupplierController controller) {
        objectForm = new ObjectForm<>(controller.getModel().getSupplier(),
                address,
                keeper,
                phoneNumber,
                fax,
    ...
    private void createUIComponents() {
        address = new AccessCheckingField<>(Supplier::getAddress,Supplier::setAddress,AccessCheckingField.NONE);
        keeper = new AccessCheckingField<>(Supplier::getKeeper,Supplier::setKeeper,AccessCheckingField.NONE);
        phoneNumber = new AccessCheckingField<>(Supplier::getPhoneNumber,Supplier::setPhoneNumber,AccessCheckingField.NONE);
        fax = new AccessCheckingField<>(Supplier::getFax,Supplier::setFax,AccessCheckingField.NONE);
        name = new AccessCheckingField<>(Supplier::getName,Supplier::setName,controller::validateName);
        shortName = new AccessCheckingField<>(Supplier::getShortName,Supplier::setShortName,controller::validateShortName);
        surcharge = new AccessCheckingField<>(Supplier::getSurcharge,Supplier::setSurcharge,AccessCheckingField.INT_FORMER);
    }
