...
public class Translator {
    ...
    public String translate(Permission permission){
        switch (permission) {
            ...
            case MANAGER:return "Ladendienst";
            case MONEY_MANAGER:return "Geld BeauftragteR";
            case ADMIN:return "Adminestator";
            default:return "No Translation";
        }
    }
    public String translate(ContainerDefinition c){
        switch (c){
            case STATIC:return "Fester Wert";
            case ROUNDED:return "Nicht genauer Wert";
            case UNKNOWN:return "Unbekannter Wert";
            default:return "No Translation";
        }
    }
    public <T> T translate(Class<T> e,String s){
        if(e.equals(Permission.class)){
            switch (s){
                case "Beginner":return (T) Permission.BEGINNER;
                case "Standart":return (T) Permission.STANDARD;
                case "Ladendienst":return (T) Permission.MANAGER;
                case "Geld BeauftragteR":return (T) Permission.MONEY_MANAGER;
                case "Adminestator":return (T) Permission.ADMIN;
                case "No Translation":return null;
            }
        }else
        if(e.equals(Unit.class)){
            switch (s){
        ...
        if(e.equals(ContainerDefinition.class)){
            switch (s){
                case "Fester Wert": return (T) ContainerDefinition.STATIC;
                case "Nicht genauer Wert": return (T) ContainerDefinition.ROUNDED;
                case "Unbekannter Wert": return (T) ContainerDefinition.UNKNOWN;
                default: return null;
            }
        }else
