...
public class ArticleField {
  public static final FieldIdentifier<Article, Integer> id =
      new FieldIdentifier<>(Article.class, "id");
  ...
  public static final FieldIdentifier<Article, VAT> vat =
      new FieldIdentifier<>(Article.class, "vat");
