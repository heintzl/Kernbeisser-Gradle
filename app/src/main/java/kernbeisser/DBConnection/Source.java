...
//X is the source for the paths, for example if the criteria query is an Article query first the source is article,
//but then on a member field property the field is the field for example on Article.priceList.id is the source PriceList.
