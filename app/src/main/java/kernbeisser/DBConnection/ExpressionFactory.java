...
public interface ExpressionFactory <P,V>{
    ...
    static <P> ExpressionFactory<P,String> upper(ExpressionFactory<P,String> stringExpressionFactory){
        return ((source, cb) -> cb.upper(stringExpressionFactory.createExpression(source,cb)));
    }


    static <P> ExpressionFactory<P,String> lower(ExpressionFactory<P,String> stringExpressionFactory){
        return ((source, cb) -> cb.lower(stringExpressionFactory.createExpression(source,cb)));
    }

    static <P,V extends Number> ExpressionFactory<P,V> diff(ExpressionFactory<P,V> a, ExpressionFactory<P,V> b){
        return ((source, cb) -> cb.diff(a.createExpression(source,cb), b.createExpression(source,cb)));
    }


    static <P> ExpressionFactory<P,Integer> mod(ExpressionFactory<P,Integer> a, ExpressionFactory<P,Integer> b){
        return ((source, cb) -> cb.mod(a.createExpression(source,cb), b.createExpression(source,cb)));
    }

    static <P,V extends Number> ExpressionFactory<P,V> minus(ExpressionFactory<P,V> a, ExpressionFactory<P,V> b){
        return ((source, cb) -> cb.sum(a.createExpression(source,cb), cb.neg(b.createExpression(source,cb))));
    }


    static <P,V extends Number> ExpressionFactory<P,V> plus(ExpressionFactory<P,V> a, ExpressionFactory<P,V> b){
