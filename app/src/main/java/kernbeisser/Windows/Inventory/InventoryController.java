...
public class InventoryController extends Controller<InventoryView, InventoryModel> {
  ...
  public void print(InventoryReports selectedReport, boolean selectedOnly, boolean outputAsPdf) {
    ...
    if (outputAsPdf) {
      report.exportPdf("Ausdruck läuft", UnexpectedExceptionHandler::showUnexpectedErrorWarning);
    } else {
      report.sendToPrinter(
          "Ausdruck läuft", UnexpectedExceptionHandler::showUnexpectedErrorWarning);
    }
  }
