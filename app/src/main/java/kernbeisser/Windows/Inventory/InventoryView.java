...
public class InventoryView implements IView<InventoryController> {
  ...
  public void initialize(InventoryController controller) {
    ...
    JButton exportShelves = new JButton("Regalexport");
    ...
    JButton shelfCounting = new JButton("Zählergebnisse");
    ...
    print.setToolTipText("Listen und Inventur-Ergebnisse ausdrucken");
    ...
    shelfLessPriceLists.setToolTipText(
        "Zeigt alle Preislisten an, die keinem Regal zugeordnet sind");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    createUIComponents();
    main = new JPanel();
    main.setLayout(new GridLayoutManager(2, 1, new Insets(4, 0, 0, 0), -1, -1));
    main.add(shelfView.$$$getRootComponent$$$(), new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    progressIndicator = new JProgressBar();
    progressIndicator.setFocusable(false);
    progressIndicator.setIndeterminate(true);
    progressIndicator.setToolTipText("Lade Summen...");
    progressIndicator.setVisible(false);
    main.add(progressIndicator, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(146, 2), null, 0, false));
  }
