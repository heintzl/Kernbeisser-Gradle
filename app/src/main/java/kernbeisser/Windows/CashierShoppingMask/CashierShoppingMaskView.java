...
public class CashierShoppingMaskView implements IView<CashierShoppingMaskController> {
  ...
  public void setUserFormsEnabled(boolean b) {
    userInfo.setEnabled(b);
    openPreOrder.setEnabled(b && controller.hasPreorderPermission());
  }
  ...
  public void initialize(CashierShoppingMaskController controller) {
    ...
    if (controller.hasPreorderPermission()) {
      openPreOrder.addActionListener(
          e -> {
            try {
              controller.openUserPreOrder();
            } catch (NoSelectionException noSelectionException) {
              messageSelectUserFirst();
            }
          });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.add(close, new GridConstraints(0, 7, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(-1, 35), null, null, 0, false));
    ...
    panel2.add(openShoppingMask, new GridConstraints(0, 6, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(-1, 35), null, null, 0, false));
    ...
    openPreOrder.setEnabled(false);
    openPreOrder.setText("Vorbestellung");
    panel2.add(openPreOrder, new GridConstraints(0, 5, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(-1, 35), null, null, 0, false));
