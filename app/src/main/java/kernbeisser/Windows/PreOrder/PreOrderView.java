...
public class PreOrderView implements IView<PreOrderController> {
  ...
  private void createUIComponents() {
    ...
    firstDatePickerSettings.setVetoPolicy(
        localDate ->
            PreOrderController.isDateAllowed(localDate, latestWeekOfDelivery.getDate(), false));
    lastDatePickerSettings.setVetoPolicy(
        localDate ->
            PreOrderController.isDateAllowed(localDate, firstWeekOfDelivery.getDate(), true));
  }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    label8.setText("Lieferung von KW");
    ...
    insertSection.add(firstWeekOfDelivery, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    final JLabel label10 = new JLabel();
    label10.setText("bis Kalenderwoche");
