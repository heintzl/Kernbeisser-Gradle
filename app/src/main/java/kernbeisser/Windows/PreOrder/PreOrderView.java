...
public class PreOrderView implements IView<PreOrderController> {
    ...
    void setLatestWeekOfDelivery(PreOrder preOrder) {
        ...
        if (weekOfYear == null) {
            ...
            int weekOfCreation = LocalDate.ofInstant(preOrder.getCreateDate(), Date.CURRENT_ZONE)
    ...
    public void initialize(PreOrderController controller) {
        ...
        alternativeKkNumber.addKeyListener(
                new KeyAdapter() {
                    @Override
                    public void keyReleased(KeyEvent e) {
                        Optional<CatalogEntry> searchResult = getAlternativeKkNumber().flatMap(controller::searchKK);
        ...
        searchCatalogAlternative.setIcon(IconFontSwing.buildIcon(FontAwesome.SEARCH, 20, new Color(49, 114, 128)));
        ...
        findAlternativeByShopNumber.setToolTipText("Alternativ-Katalog-Eintrag über Ladennummer suchen");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        alternativeContainerSize.setText("Label");
        ...
        alternativeNetPrice.setText("Label");
