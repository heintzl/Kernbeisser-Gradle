  ...
  private void $$$setupUI$$$() {
    ...
    menuPanel.add(
        ...
        new GridConstraints(
            ...
            0,
            false));
    menugroupMyAccount.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            "Mein {Storename}-Konto",
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, -1, 18, menugroupMyAccount.getFont()),
            null));
    final Spacer spacer1 = new Spacer();
    menugroupMyAccount.add(
        spacer1,
        new GridConstraints(
            7,
            0,
    ...
    panel1.setLayout(new GridLayoutManager(9, 1, new Insets(10, 10, 10, 10), -1, -1));
    menuPanel.add(
        panel1,
        new GridConstraints(
            0,
    ...
    panel5.setBorder(
        BorderFactory.createTitledBorder(
            ...
            TitledBorder.DEFAULT_JUSTIFICATION,
            TitledBorder.DEFAULT_POSITION,
            this.$$$getFont$$$(null, -1, 18, panel5.getFont()),
            null));
